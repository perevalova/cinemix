...
;(function(factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['movie/static/js/jquery'], factory);
    } else if (typeof exports !== 'undefined') {
        module.exports = factory(require('movie/static/js/jquery'));
    } else {
        factory(jQuery);
    }
